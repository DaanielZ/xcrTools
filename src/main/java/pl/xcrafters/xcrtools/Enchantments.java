...
public class Enchantments {
    ...
    public static Map<String, Enchantment> ALIASENCHANTMENTS = new HashMap<String, Enchantment>();

    ToolsPlugin plugin;

    public Enchantments(ToolsPlugin plugin) {
        this.plugin = plugin;
        loadEnchantments();
    }
    ...
    public static Enchantment getEnchantment(String string) {
        ...
        } else if (ALIASENCHANTMENTS.get(enchantmentName) != null) {
            return ALIASENCHANTMENTS.get(enchantmentName);
        } else {
            return null;
        }
    }
